...
# The script plots the Energy Sub-metering (1, 2, and 3 in watt-hour of active energy)
# over the two days.
# 
...
plot(household_data$Date_and_time, household_data$Sub_metering_1, type = "l",
     xlab = "", ylab = "Energy sub metering")

## Add the Sub_metering_2 data in red
lines(household_data$Date_and_time, household_data$Sub_metering_2, col = "red")

## Add the Sub_metering_3 data in blue
lines(household_data$Date_and_time, household_data$Sub_metering_3, col = "blue")
